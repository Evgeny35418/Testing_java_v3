...
public class TestBase {
  ...
  protected void gotoGroupNew() {
    wd.findElement(By.name("new")).click();
  }

  protected void creatingANewUser() {
    wd.findElement(By.xpath("//div[@id='content']/form/input[21]")).click();
  }

  protected void fillAddNewForm(NewUser newUser) {
  ...
  protected void deleteGroupDelete() {
    wd.findElement(By.name("delete")).click();
  }

  protected void selectGroup() {
    wd.findElement(By.xpath("//span[2]/input")).click();
  }
